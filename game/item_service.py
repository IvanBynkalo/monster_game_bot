ITEMS = {
    ...
    "flee_elixir": {
        "name": "Эликсир побега",
        "emoji": "💨",
        "description": "+25% к шансу побега. Минимальный шанс 40%. Использовать в бою.",
    },
    "revival_shard": {
        "name": "Осколок возрождения",
        "emoji": "💎",
        "description": "Оживляет павшего монстра с 30% HP. Редкий предмет.",
    },
}
