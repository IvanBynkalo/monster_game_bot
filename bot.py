...
dp.message.register(
    craft_item_handler,
    text_startswith("🧪 Создать:", "🪤 Создать:", "✨ Создать:"),
)
...
# Специализированные переходы и возвраты ставим выше общего "Назад"
...
# Общий возврат оставляем последним, чтобы он не перехватывал узкие сценарии раньше времени
